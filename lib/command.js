        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (flags.verbose) {
                ...
                qa.engine.bus.on("scenario", (e) => {
                    console.log(chalk_1.default.yellow("Scenario: %s (%s steps)").padStart(2), e.scenario.title, e.scenario.steps.length);
                });
            }
            if (flags.debug) {
            ...
            qa.engine.bus.on("step:fail", (e) => {
                console.log(chalk_1.default.red("step:fail: %s").padStart(4), e.step);
            });
            if (flags.target) {
