        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (flags.verbose) {
                ...
                qa.engine.bus.on("scenario", (e) => {
                    console.log(chalk_1.default.green("scenario: %s -> %o").padStart(2), e.scenario.title, e.scenario.annotations);
                });
            }
            if (flags.debug) {
                qa.engine.bus.on("step", (e) => {
                    console.log(chalk_1.default.white("step: %s").padStart(4), e.step);
                });
            }
            ...
            qa.engine.read(scope, folder)
                .then((_results) => {
                flags.verbose && console.log(chalk_1.default.bold.green("test results: %o / %o"), _results.total - _results.fails, _results.total);
